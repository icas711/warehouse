...
class _EditWidgetState extends State<EditWidget> {
  ...
  void initState() {
    super.initState();
    name.text = widget.currentItem.name;
    measurement_units.text = widget.currentItem.measurement_units ?? '';
    description.text = widget.currentItem.description ?? '';
    code.text = widget.currentItem.code ?? '';
  }
                ...
                return Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          context.read<EditBloc>().add(EditEvent.fetch(
