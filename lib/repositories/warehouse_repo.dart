...
class WarehouseRepo {
  ...
  Future<WarehouseItem> getWarehouseItems(
      int page, int pageSize, String itemName, String sortBy, String sortOrder, String token) async {
    try {
      final response = await http.get(
        Uri.parse('$url&page=$page&pageSize=$pageSize&itemName=$itemName&sortBy=$sortBy&sortOrder=$sortOrder'),
